...
<?php require("navbar.php");?>
  ...
  <h2 style="text-align:center; color: saddlebrown">Second Semester result</h2>
  <table>
  ...
  <table>
    ...
    <tr>
      <th>Programming fundamental T</th>
      <td>28</td>
      <td>45</td>
      <td>15</td>
      <td>4</td>
    ...
    <tr>
      <th>Programming fundamental P</th>
      <td>N/A</td>
      <td>75</td>
      <td>12</td>
      <td>4</td>
    ...
    <tr>
      <th>Electric devices and Circuit T</th>
      <td>24</td>
      <td>35</td>
      <td>10</td>
      <td>3.3</td>
    ...
    <tr>
      <th>Electric devices and Circuit P</th>
      <td>N/A</td>
      <td>65</td>
      <td>10</td>
      <td>3.7</td>
  ...
  <div class="mov-button">
    <button class="button"><a href="semester1.php" target="_blank">Previous</a></button>
    <button class="button"><a href="semester3.php" target="_blank">next</a></button>
  </div>
  <footer class="footer">
